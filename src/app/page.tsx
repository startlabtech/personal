...
import logoEtika from '@/images/logos/etika.svg'
import logoOrchestrated from '@/images/logos/orchestrated.svg'
import logoOrigin from '@/images/logos/origin.svg'
import image3 from '@/images/photos/family.jpg'
import image1 from '@/images/photos/presenting.jpeg'
import image4 from '@/images/photos/skiing.jpg'
import image5 from '@/images/photos/woodwork.jpg'
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image1, image4, image3, image5].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
